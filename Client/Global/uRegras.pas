...
type
  ...
  private
    ...
    FUsuarioDepartamentoPorUsuarioCommand: TDBXCommand;
  ...
  public
    ...
    function UsuarioDepartamentoPorUsuario(AIdUsuario: Integer): TJSONValue;
  ...
  private
    ...
    FOrcamentoNovoCommand: TDBXCommand;
  ...
  public
    ...
    function OrcamentoNovo(AIdUsuario: Integer): TJSONValue;
...
function TServerMethods1Client.UsuarioDepartamentoPorUsuario(AIdUsuario: Integer): TJSONValue;
begin
  if FUsuarioDepartamentoPorUsuarioCommand = nil then
  begin
    FUsuarioDepartamentoPorUsuarioCommand := FDBXConnection.CreateCommand;
    FUsuarioDepartamentoPorUsuarioCommand.CommandType := TDBXCommandTypes.DSServerMethod;
    FUsuarioDepartamentoPorUsuarioCommand.Text := 'TServerMethods1.UsuarioDepartamentoPorUsuario';
    FUsuarioDepartamentoPorUsuarioCommand.Prepare;
  end;
  FUsuarioDepartamentoPorUsuarioCommand.Parameters[0].Value.SetInt32(AIdUsuario);
  FUsuarioDepartamentoPorUsuarioCommand.ExecuteUpdate;
  Result := TJSONValue(FUsuarioDepartamentoPorUsuarioCommand.Parameters[1].Value.GetJSONValue(FInstanceOwner));
end;
...
begin
  ...
  FUsuarioDepartamentoPorUsuarioCommand.DisposeOf;
...
function TServerModule2Client.OrcamentoNovo(AIdUsuario: Integer): TJSONValue;
begin
  if FOrcamentoNovoCommand = nil then
  begin
    FOrcamentoNovoCommand := FDBXConnection.CreateCommand;
    FOrcamentoNovoCommand.CommandType := TDBXCommandTypes.DSServerMethod;
    FOrcamentoNovoCommand.Text := 'TServerModule2.OrcamentoNovo';
    FOrcamentoNovoCommand.Prepare;
  end;
  FOrcamentoNovoCommand.Parameters[0].Value.SetInt32(AIdUsuario);
  FOrcamentoNovoCommand.ExecuteUpdate;
  Result := TJSONValue(FOrcamentoNovoCommand.Parameters[1].Value.GetJSONValue(FInstanceOwner));
end;
...
begin
  ...
  FOrcamentoNovoCommand.DisposeOf;
