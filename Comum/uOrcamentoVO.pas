...
type
  ...
  TOrcamentoViewModel = class
  private
    FId: Integer;
    FCodigo: Integer;
    FModeloImpressao: Integer;
    FObservacaoPadrao: string;
    FTextoEmailPadrao: string;
    FIdUsuario: Integer;
    FCodUsuario: Integer;
    FNomeUsuario: string;
    FIdTipo: Integer;
  ...
  public
    ...
    property ModeloImpressao: Integer read FModeloImpressao write FModeloImpressao;
    property ObservacaoPadrao: string read FObservacaoPadrao write FObservacaoPadrao;
    property TextoEmailPadrao: string read FTextoEmailPadrao write FTextoEmailPadrao;
