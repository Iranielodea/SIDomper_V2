...
--VERSAO 1.000.49
-------------------------------------------------------------------------------
ALTER TABLE Departamento ADD Dep_ModeloImprOrcamento int
GO
UPDATE Departamento SET Dep_ModeloImprOrcamento = 1 WHERE Dep_ModeloImprOrcamento IS NULL
GO

ALTER TABLE Produto ADD Prod_Observacao varchar(1000)
GO
ALTER TABLE Modulo ADD Mod_Observacao varchar(1000)
GO