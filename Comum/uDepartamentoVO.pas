...
type
  ...
  private
    ...
    procedure SetModeloImprOrcamento(const Value: Integer);
  public
    [keyField('Dep_Id')]
    ...
    [FieldTime('Dep_HoraAtendeInicial')]
    property HoraInicial: TTime read FHoraInicial write SetHoraInicial;
    [FieldTime('Dep_HoraAtendeFinal')]
    property HoraFinal: TTime read FHoraFinal write SetHoraFinal;
    [FieldTime('Dep_ModeloImprOrcamento')]
    property ModeloImprOrcamento: Integer read FModeloImprOrcamento write SetModeloImprOrcamento;
...
procedure TDepartamentoVO.SetModeloImprOrcamento(const Value: Integer);
begin
  FModeloImprOrcamento := Value;
end;
