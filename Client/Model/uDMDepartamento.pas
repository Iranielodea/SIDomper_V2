...
type
  TDMDepartamento = class(TDMBase)
    ...
    CDSCadastroDep_SolicitaOcorRegra: TBooleanField;
    CDSCadastroDep_HoraAtendeInicial: TTimeField;
    CDSCadastroDep_HoraAtendeFinal: TTimeField;
    CDSCadastroDep_ModeloImprOrcamento: TIntegerField;
    ...
    procedure CDSCadastroDep_HoraAtendeInicialSetText(Sender: TField;
      const Text: string);
    procedure CDSCadastroDep_HoraAtendeFinalSetText(Sender: TField;
      const Text: string);
  private
...
procedure TDMDepartamento.CDSCadastroDep_HoraAtendeFinalSetText(Sender: TField;
  const Text: string);
begin
  inherited;
...
procedure TDMDepartamento.CDSCadastroDep_HoraAtendeInicialSetText(
...
begin
  ...
  CDSCadastroDep_SolicitaOcorRegra.AsBoolean := True;
  CDSCadastroDep_ModeloImprOrcamento.AsInteger := 1;
end;
