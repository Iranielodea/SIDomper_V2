inherited DMDepartamento: TDMDepartamento
  ...
  inherited CDSCadastro: TClientDataSet
    ...
    object CDSCadastroDep_SolicitaOcorRegra: TBooleanField
      FieldName = 'Dep_SolicitaOcorRegra'
    end
    object CDSCadastroDep_HoraAtendeInicial: TTimeField
      FieldName = 'Dep_HoraAtendeInicial'
      OnSetText = CDSCadastroDep_HoraAtendeInicialSetText
      DisplayFormat = 'hh:mm'
      EditMask = '##:##'
    end
    object CDSCadastroDep_HoraAtendeFinal: TTimeField
      FieldName = 'Dep_HoraAtendeFinal'
      OnSetText = CDSCadastroDep_HoraAtendeFinalSetText
      DisplayFormat = 'hh:mm'
      EditMask = '##:##'
    end
    object CDSCadastroDep_ModeloImprOrcamento: TIntegerField
      FieldName = 'Dep_ModeloImprOrcamento'
    end
  end
