...
type
  ...
  public
    ...
    function ObterUsuarioDepartamento( AIdUsuario: Integer): TUsuarioDepartamentoViewModel;
...
function TUsuarioController.ObterUsuarioDepartamento( AIdUsuario: Integer): TUsuarioDepartamentoViewModel;
var
  Negocio: TServerMethods1Client;
begin
  DM.Conectar;
  Negocio := TServerMethods1Client.Create(DM.Conexao.DBXConnection);
  try
    Result := TConverte.JSONToObject<TUsuarioDepartamentoViewModel>(Negocio.UsuarioDepartamentoPorUsuario(AIdUsuario));
    dm.Desconectar;
  finally
    FreeAndNil(Negocio);
  end;
