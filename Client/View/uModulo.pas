...
procedure TfrmModulo.mmoObsEnter(Sender: TObject);
begin
  Self.KeyPreview := False;
end;

procedure TfrmModulo.mmoObsExit(Sender: TObject);
begin
  Self.KeyPreview := True;
end;

procedure TfrmModulo.mmoObsKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if Key = VK_F8 then
    btnSalvar.Click;
