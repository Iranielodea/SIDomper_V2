...
var
  ...
  recadoModel: TRecadoVO;
  listaRecados: TObjectList<TRecadoVO>;
begin
  Recado := TRecadoController.Create;
  listaRecados := TObjectList<TRecadoVO>.Create();
  try
    try
      Recado.Quadro(0,0);
      ...
      begin
        RecadoModel := TRecadoVO.create;
        recadoModel.Id := Recado.Model.CDSLctoRec_Id.AsInteger;
        recadoModel.IdUsuarioLcto := Recado.Model.CDSLctoRec_UsuarioLcto.AsInteger;
        recadoModel.IdUsuarioDestino := Recado.Model.CDSLctoRec_UsuarioDestino.AsInteger;

        listaRecados.Add(recadoModel);
...
//                           Recado.Model.CDSLctoRec_Id.AsInteger);
      ...
      Recado.EnviarListaEmail(listaRecados);
    except
      On E: Exception do
      begin
