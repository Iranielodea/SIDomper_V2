...
uses
  ...
  ppChrt, Vcl.Graphics, System.Generics.Collections, Vcl.Dialogs, uEnumerador;
...
type
  TDMOrcamento = class(TDMBase)
    ...
    ppLabel42: TppLabel;
    ppLabel47: TppLabel;
    RelImpressaoSimplesAgroD: TppReport;
    ...
    RegMensalidadeSimplesAgroD: TppRegion;
    ...
    ppDBRichText19: TppDBRichText;
    ppRegion7: TppRegion;
    ppLine48: TppLine;
    ppImage24: TppImage;
    ppSubReport40: TppSubReport;
    ...
    ppDesignLayers41: TppDesignLayers;
    ppDesignLayer41: TppDesignLayer;
    ppDesignLayers42: TppDesignLayers;
    ppDesignLayer42: TppDesignLayer;
    ppMemo1: TppMemo;
    ppGroup8: TppGroup;
    ppGroupHeaderBand7: TppGroupHeaderBand;
    ppGroupFooterBand7: TppGroupFooterBand;
    ppSubReport42: TppSubReport;
    ppChildReport42: TppChildReport;
    ppTitleBand32: TppTitleBand;
    ppLabel156: TppLabel;
    ppDetailBand48: TppDetailBand;
    ppDBText136: TppDBText;
    ppDBRichText21: TppDBRichText;
    ppSummaryBand43: TppSummaryBand;
    ppDesignLayers43: TppDesignLayers;
    ppDesignLayer43: TppDesignLayer;
    ppDesignLayers44: TppDesignLayers;
    ppDesignLayer44: TppDesignLayer;
    ppLine50: TppLine;
    ppDesignLayers45: TppDesignLayers;
    ppDesignLayer45: TppDesignLayer;
    ppDesignLayers46: TppDesignLayers;
    ppDesignLayer46: TppDesignLayer;
    ppDBText137: TppDBText;
    ppDesignLayers47: TppDesignLayers;
    ppDesignLayer47: TppDesignLayer;
    ppDesignLayers48: TppDesignLayers;
    ppDesignLayer48: TppDesignLayer;
    ppDBMemo1: TppDBMemo;
    ppLabel157: TppLabel;
    ppImage26: TppImage;
    ppLine51: TppLine;
    ...
    ppLabel160: TppLabel;
    plblOrcamento03: TppLabel;
    ppLabel162: TppLabel;
    ppDBText142: TppDBText;
    ppDesignLayers49: TppDesignLayers;
    ppDesignLayer49: TppDesignLayer;
    ...
    ppLabel165: TppLabel;
    ppLabel166: TppLabel;
    ppDesignLayers50: TppDesignLayers;
    ppDesignLayer50: TppDesignLayer;
    ...
    procedure ppDetailBand33BeforePrint(Sender: TObject);
  private
    ...
    FTotalItem: Currency;
    FEmail: string;
    FTipoOrcamento: TEnumPrograma;
  public
    { Public declarations }
    procedure GerarPDF(ANomeArquivo, ATipoRel: string);
    procedure GerarPDFAgroD(ANomeArquivo, ATipoRel: string);
    procedure ImpressaoTela(ATipoRel: string);
    procedure ImpressaoTelaAgroD(ATipoRel: string);
    ...
    procedure ImpressaoRelatorioSimplificadoAgroD(AEmail: string);
    ...
    property TipoOrcamento: TEnumPrograma read FTipoOrcamento write FTipoOrcamento;
  end;
...
begin
  ...
  begin
    ...
    if FTipoOrcamento = prOrcamento then
      CDSImpressaoCidade_Data.AsString := 'Vacaria, ' + FormatDateTime('dd " de "mmmm " de " yyyy', CDSImpressaoOrc_Data.AsDateTime)
    else
      CDSImpressaoCidade_Data.AsString := 'Caxias do Sul, ' + FormatDateTime('dd " de "mmmm " de " yyyy', CDSImpressaoOrc_Data.AsDateTime);
...
procedure TDMOrcamento.GerarPDFAgroD(ANomeArquivo, ATipoRel: string);
begin
  if ATipoRel = 'DETA' then
  begin
    RelImpressao.ShowPrintDialog := False;
    ...
    RelImpressaoSimplesAgroD.ShowPrintDialog := False;
    RelImpressaoSimplesAgroD.AllowPrintToFile := True;
    RelImpressaoSimplesAgroD.TextFileName := ANomeArquivo;
    RelImpressaoSimplesAgroD.DeviceType := 'PDF';
  end;
...
procedure TDMOrcamento.ImpressaoRelatorioSimplificadoAgroD(AEmail: string);
var
  sFones: string;
  sIE: string;
begin
  ...
  if CDSImpressaoOrc_Fantasia.AsString <> '' then
    mmOrcamento2.Lines.Add(CDSImpressaoOrc_Fantasia.AsString);

  if CDSImpressaoOrc_Logradouro.AsString <> '' then
    mmOrcamento2.Lines.Add(CDSImpressaoOrc_Logradouro.AsString);

  if CDSImpressaoOrc_Bairro.AsString <> '' then
    mmOrcamento2.Lines.Add(CDSImpressaoOrc_Bairro.AsString);

  if CDSImpressaoCid_Nome.AsString <> '' then
    mmOrcamento2.Lines.Add(CDSImpressaoCid_Nome.AsString + ' - ' + CDSImpressaoCid_UF.AsString);

  if CDSImpressaoOrc_CEP.AsString <> '' then
    mmOrcamento2.Lines.Add(CDSImpressaoOrc_CEP.AsString);

  if CDSImpressaoOrc_Dcto.AsString <> '' then
    mmOrcamento2.Lines.Add('CPNJ/CPF: ' + CDSImpressaoOrc_Dcto.AsString + sIE);



//  if CDSImpressaoOrc_ContatoFinanceiro.AsString <> '' then
//    mmOrcamento2.Lines.Add(CDSImpressaoOrc_ContatoFinanceiro.AsString + ' - ' + CDSImpressaoOrc_ContatoFinanceiroFone.AsString);

  if CDSImpressaoOrc_ContatoCompraVenda.AsString <> '' then
    mmOrcamento2.Lines.Add(CDSImpressaoOrc_ContatoCompraVenda.AsString + ' ' + CDSImpressaoOrc_ContatoCompraVendaFone.AsString);
//    mmOrcamento2.Lines.Add(CDSImpressaoOrc_ContatoCompraVenda.AsString + ' - ' + CDSImpressaoOrc_ContatoCompraVendaFone.AsString);

  if sFones <> '' then
    mmOrcamento2.Lines.Add(sFones);

//  if CDSImpressaoOrc_RepreLegal.AsString <> '' then
//    mmOrcamento2.Lines.Add(CDSImpressaoOrc_RepreLegal.AsString + ' - ' + CDSImpressaoOrc_RepreLegalCPF.AsString);

  mmOrcamento2.Lines.Add(AEmail);
  mmOrcamento2.Lines.Add('Repr. Legal: ' + CDSImpressaoOrc_RepreLegal.AsString);
  mmOrcamento2.Lines.Add('CPF: ' + CDSImpressaoOrc_RepreLegalCPF.AsString);
end;
...
procedure TDMOrcamento.ImpressaoTelaAgroD(ATipoRel: string);
begin
  if ATipoRel = 'DETA' then
  begin
    RelImpressaoAgroD.ShowPrintDialog := True;
    RelImpressaoAgroD.AllowPrintToArchive := False;
    RelImpressaoAgroD.TextFileName := '';
    RelImpressaoAgroD.DeviceType := 'Screen';
  end
  else begin
    RelImpressaoSimplesAgroD.ShowPrintDialog := True;
    RelImpressaoSimplesAgroD.AllowPrintToArchive := False;
    RelImpressaoSimplesAgroD.TextFileName := '';
    RelImpressaoSimplesAgroD.DeviceType := 'Screen';
  end;
...
procedure TDMOrcamento.ppDetailBand33BeforePrint(Sender: TObject);
begin
  RegMensalidadeSimplesAgroD.Visible := (CDSImpressaoOrcIte_ValorLicencaMensal.AsCurrency > 0);
end;
