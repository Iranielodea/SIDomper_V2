...
type
  ...
  TUsuarioDepartamentoViewModel = class
  private
    FModeloImpressaoOrcamento: Integer;
    FCodUsuario: Integer;
    procedure SetCodUsuario(const Value: Integer);
    procedure SetModeloImpressaoOrcamento(const Value: Integer);
  public
    property CodUsuario: Integer read FCodUsuario write SetCodUsuario;
    property ModeloImpressaoOrcamento: Integer read FModeloImpressaoOrcamento write SetModeloImpressaoOrcamento;
  end;
...
{ TUsuarioDepartamentoViewModel }

procedure TUsuarioDepartamentoViewModel.SetCodUsuario(const Value: Integer);
begin
  FCodUsuario := Value;
end;

procedure TUsuarioDepartamentoViewModel.SetModeloImpressaoOrcamento(
  const Value: Integer);
begin
  FModeloImpressaoOrcamento := Value;
end;
