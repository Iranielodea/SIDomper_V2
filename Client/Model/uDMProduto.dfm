inherited DMProduto: TDMProduto
  ...
  inherited CDSConsulta: TClientDataSet
    ...
    object CDSConsultaProd_Id: TAutoIncField
      FieldName = 'Prod_Id'
      Origin = 'Prod_Id'
    ...
    object CDSConsultaProd_Ativo: TBooleanField
  ...
  inherited CDSCadastro: TClientDataSet
    ProviderName = 'dspProdutoCad'
    RemoteServer = DM.DSPConexao
    OnNewRecord = CDSCadastroNewRecord
    OnReconcileError = CDSCadastroReconcileError
    object CDSCadastroProd_Id: TAutoIncField
      AutoGenerateValue = arAutoInc
      FieldName = 'Prod_Id'
      ProviderFlags = [pfInWhere, pfInKey]
    end
    object CDSCadastroProd_Ativo: TBooleanField
      FieldName = 'Prod_Ativo'
      Required = True
    end
    ...
    object CDSCadastroProd_Observacao: TStringField
